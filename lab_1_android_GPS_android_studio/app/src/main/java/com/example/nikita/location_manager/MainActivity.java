...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkLocationPermission()
    {
        ...
        if (res_1 == PackageManager.PERMISSION_GRANTED) {
            ...
            locationManager_NETWORK.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 400, 4, locationListenerN);
        }
    }
    ...
    LocationListener locationListenerN = new LocationListener() {
        @Override
        public void onLocationChanged(android.location.Location location) {
            double speed = location.getSpeed() * 3.6;
            String speed_msg = "Speed(net): " + speed + "km/h";
            
            TextView speed_text = findViewById(R.id.speed_internet);
